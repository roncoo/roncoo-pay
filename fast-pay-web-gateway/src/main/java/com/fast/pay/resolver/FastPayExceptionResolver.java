...
public class FastPayExceptionResolver implements HandlerExceptionResolver {

    private static final Logger LOG = LoggerFactory.getLogger(FastPayExceptionResolver.class);
