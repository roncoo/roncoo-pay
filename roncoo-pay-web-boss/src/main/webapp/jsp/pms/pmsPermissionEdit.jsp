...
<div class="pageContent">
	<form id="form" method="post" action="${baseURL}/pms/permission/edit" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
		<div class="pageFormContent" layoutH="58">
			<input type="hidden" name="navTabId" value="listPmsPermission">
			<input type="hidden" name="callbackType" value="closeCurrent">
			<input type="hidden" name="forwardUrl" value="">

			<input type="hidden" name="permissionId" value="${pmsPermission.id }">
			...
			<p style="height: 50px;">
				<label>权限描述：</label>
				<textarea rows="3" cols="27" name="desc" class="required" minlength="3" maxlength="60">${pmsPermission.remark}</textarea>
			</p>
		</div>
		<div class="formBar">
			<ul>
