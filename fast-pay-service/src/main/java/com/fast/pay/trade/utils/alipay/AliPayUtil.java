package com.fast.pay.trade.utils.alipay;
...
import com.fast.pay.trade.utils.alipay.sign.MD5;
...
public class AliPayUtil {
     ...
     * @param amount
     * @param body
     * @param fastPayGoodsDetailses
     * @return
     */
    public static Map<String, Object> tradePay(String outTradeNo, String authCode, String subject, BigDecimal amount, String body, List<FastPayGoodsDetails> fastPayGoodsDetailses) {
        logger.info("======>支付宝被扫");
        ...
        // 商品明细列表，需填写购买商品详细信息，
        if (fastPayGoodsDetailses != null && fastPayGoodsDetailses.size() > 0) {
            List<SortedMap<String, Object>> goodsList = new ArrayList<>();
            for (FastPayGoodsDetails fastPayGoodsDetails : fastPayGoodsDetailses) {
                SortedMap<String, Object> goodsMap = new TreeMap<>();
                goodsMap.put("goods_id", fastPayGoodsDetails.getGoodsId());
                goodsMap.put("goods_name", fastPayGoodsDetails.getGoodsName());
                goodsMap.put("quantity", fastPayGoodsDetails.getNums());
                goodsMap.put("price", fastPayGoodsDetails.getSinglePrice());
