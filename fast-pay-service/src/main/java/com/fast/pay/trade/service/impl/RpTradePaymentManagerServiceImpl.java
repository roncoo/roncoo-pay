...
import com.fast.pay.common.core.enums.PayTypeEnum;
...
import com.fast.pay.trade.entity.FastPayGoodsDetails;
import com.fast.pay.trade.entity.RpTradePaymentOrder;
import com.fast.pay.trade.entity.RpTradePaymentRecord;
import com.fast.pay.trade.entity.weixinpay.WeiXinPrePay;
...
import com.fast.pay.trade.enums.alipay.AliPayTradeStateEnum;
import com.fast.pay.trade.enums.weixinpay.WeiXinTradeTypeEnum;
import com.fast.pay.trade.enums.weixinpay.WeixinTradeStateEnum;
import com.fast.pay.trade.service.RpTradePaymentManagerService;
import com.fast.pay.trade.utils.MerchantApiUtil;
import com.fast.pay.trade.utils.WeiXinPayUtils;
import com.fast.pay.trade.utils.WeixinConfigUtil;
import com.fast.pay.trade.utils.alipay.AliPayUtil;
import com.fast.pay.trade.utils.alipay.config.AlipayConfigUtil;
import com.fast.pay.trade.utils.alipay.util.AlipayNotify;
import com.fast.pay.trade.utils.alipay.util.AlipaySubmit;
import com.fast.pay.trade.utils.weixin.WeiXinPayUtil;
import com.fast.pay.trade.vo.*;
...
import com.fast.pay.user.service.*;
...
public class RpTradePaymentManagerServiceImpl implements RpTradePaymentManagerService {
     ...
     * @return
     */
    private F2FPayResultVo getF2FPayResultVo(RpTradePaymentOrder rpTradePaymentOrder, RpPayWay payWay, String payKey, String merchantPaySecret, String authCode, List<FastPayGoodsDetails> fastPayGoodsDetailses) {
        ...
        if (PayWayEnum.WEIXIN.name().equals(payWayCode)) {// 微信支付
            ...
            Map<String, Object> resultMap = AliPayUtil.tradePay(rpTradePaymentRecord.getBankOrderNo(), authCode, rpTradePaymentOrder.getProductName(), rpTradePaymentRecord.getOrderAmount(), "", fastPayGoodsDetailses);
     ...
     * @return
     */
    private ProgramPayResultVo getProgramPayResultVo(RpTradePaymentOrder tradePaymentOrder, RpPayWay payWay, String merchantPaySecret, String openId, List<FastPayGoodsDetails> fastPayGoodsDetailses) {
        ...
        if (PayWayEnum.WEIXIN.name().equals(payWayCode)) {// 微信支付
            Map<String, Object> resultMap = WeiXinPayUtil.appletPay(rpTradePaymentRecord.getBankOrderNo(), rpTradePaymentRecord.getProductName(), rpTradePaymentRecord.getOrderAmount(), rpTradePaymentRecord.getOrderIp(), rpTradePaymentRecord.getNotifyUrl(), openId, fastPayGoodsDetailses);
